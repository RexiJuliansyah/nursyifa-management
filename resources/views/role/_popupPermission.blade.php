        ...
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <div class="panel panel-default mb-10">
                        <div class="panel-body form-horizontal">
                            ...
                            <div class="pull-right">
                                ...
                                <button type="button" class="btn btn-primary btn-sm" id="btn_all_access">All Permission</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="btn_save_permission" class="btn btn-primary btn-sm">Save</button>
                </div>
            </div>
        </div>
    </div>
