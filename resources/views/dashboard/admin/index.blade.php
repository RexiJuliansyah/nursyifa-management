					...
					<div class="panel-body row pa-0">
						<div class="sm-data-box">
							<div class="container-fluid">
								<div class="row">
									<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
										<span class=""><i class="zmdi zmdi-trending-up txt-warning font-18 mr-5"></i><span class="weight-500 uppercase-font">growth</span></span>
						...
						<div class="table-wrap">
							<div class="table-responsive">
								...
								<tbody>
									...
									<td>1</td>
									<td>Milk Powder</td>
									<td><span class="peity-bar" data-width="90" data-peity='{ "fill": ["#667add"], "stroke":["#667add"]}' data-height="40">0,-3,-2,-4,5,-4,3,-2,5,-1</span> </td>
									<td><span class="text-danger text-semibold"><i class="fa fa-level-down" aria-hidden="true"></i> 28.76%</span> </td>
									</tr>
									<tr>
									<td>2</td>
									<td>Air Conditioner</td>
									<td><span class="peity-bar" data-width="90" data-peity='{ "fill": ["#667add"], "stroke":["#667add"]}' data-height="40">0,-1,1,-2,-3,1,-2,-3,1,-2</span> </td>
									<td><span class="text-warning text-semibold"><i class="fa fa-level-down" aria-hidden="true"></i> 8.55%</span> </td>
									</tr>
									<tr>
									<td>3</td>
									<td>RC Cars</td>
									<td><span class="peity-bar" data-width="90" data-peity='{ "fill": ["#667add"], "stroke":["#667add"]}' data-height="40">0,3,6,1,2,4,6,3,2,1</span> </td>
									<td><span class="text-success text-semibold"><i class="fa fa-level-up" aria-hidden="true"></i> 58.56%</span> </td>
									</tr>
									<tr>
									<td>4</td>
									<td>Down Coat</td>
									<td><span class="peity-bar" data-width="90" data-peity='{ "fill": ["#667add"], "stroke":["#667add"]}' data-height="40">0,3,6,4,5,4,7,3,4,2</span> </td>
					...
					<div class="panel-body">
						<div class="streamline user-activity">
							<div class="sl-item">
								<a href="javascript:void(0)">
									<div class="sl-avatar avatar avatar-sm avatar-circle">
										<img class="img-responsive img-circle" src="{{asset('admin')}}/dist/img/user.png" alt="avatar"/>
									</div>
							...
							<div class="sl-item">
								<a href="javascript:void(0)">
									<div class="sl-avatar avatar avatar-sm avatar-circle">
										<img class="img-responsive img-circle" src="{{asset('admin')}}/dist/img/user1.png" alt="avatar"/>
									</div>
									<div class="sl-content">
										...
										<div class="activity-thumbnail">
											<img src="{{asset('admin')}}/dist/img/thumb-1.jpg" alt="thumbnail"/>
											<img src="{{asset('admin')}}/dist/img/thumb-2.jpg" alt="thumbnail"/>
											<img src="{{asset('admin')}}/dist/img/thumb-3.jpg" alt="thumbnail"/>
										</div>
							...
							<div class="sl-item">
								<a href="javascript:void(0)">
									<div class="sl-avatar avatar avatar-sm avatar-circle">
										<img class="img-responsive img-circle" src="{{asset('admin')}}/dist/img/user2.png" alt="avatar"/>
									</div>
									<div class="sl-content">
							...
							<div class="sl-item">
								<a href="javascript:void(0)">
									<div class="sl-avatar avatar avatar-sm avatar-circle">
										<img class="img-responsive img-circle" src="{{asset('admin')}}/dist/img/user3.png" alt="avatar"/>
									</div>
									<div class="sl-content">
							...
							<div class="sl-item">
								<a href="javascript:void(0)">
									<div class="sl-avatar avatar avatar-sm avatar-circle">
										<img class="img-responsive img-circle" src="{{asset('admin')}}/dist/img/user4.png" alt="avatar"/>
									</div>
									<div class="sl-content">
