...
var elmer = function () {
    ...
    $(document).on("click", "body", function (e) {
        if (
            $(e.target).closest(".fixed-sidebar-right,.setting-panel").length >
            0
        ) {
            return;
        }
    ...
    $(document).on("keypress", "#input_msg_send", function (e) {
        if (e.which == 13 && !$(this).val().length == 0) {
            $(
                ...
                ".fixed-sidebar-right .chat-content  ul li:last-child"
            );
            $(this).val("");
        } else if (e.which == 13) {
            alert("Please type somthing!");
    ...
    $(document).on("keypress", "#input_msg_send_chatapp", function (e) {
        if (e.which == 13 && !$(this).val().length == 0) {
            $(
                ...
                ".chat-for-widgets-1 .chat-content  ul li:last-child"
            );
            $(this).val("");
        } else if (e.which == 13) {
    ...
    $(document).on("click", ".fixed-sidebar-right #goto_back", function (e) {
        $(".fixed-sidebar-right .chat-cmplt-wrap").removeClass(
            "chat-box-slide"
        );
        return false;
    });
